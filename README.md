**Palmer Penguins: Exploratory Data Analysis ** This project explores the Palmer Penguins dataset using a complete, professional EDA workflow. The analysis includes data inspection, missingness evaluation, univariate and bivariate exploration, visualization, correlation analysis, and statistical testing.
...
Dataset Palmer Penguins dataset (publicly available)
